    ...
    <fieldset style="width: 50%; height: 450px;">
        ...
        <?php
            ...
            if (isset($_GET['sl'])) {		
                ...
                $sql = "INSERT INTO client(Name, Gender, DateOfBirth, Contact, Email, Username, Password) VALUES ('$name', '$gender', '$dob', '$phone', '$email', '$username', '$password')";
                $qry = $ezl->query($sql);
            ...
            echo "<h3>✅Client Request Approved</h3><br>";
        ?>
